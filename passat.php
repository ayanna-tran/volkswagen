      ...
      <div class="main-product">
        <div id="tong-quan" class="block-product">
          ...
          <div class="content-block">
            <p>- Passat Bluemotion là một chiếc Sedan hạng D chung phân khúc với Toyota Camry, Mazda6, Honda Accord. Passat toát lên vẻ lịch lãm, cứng cáp chuẩn xe sang dành cho doanh nhân. Qua 8 thế hệ phát triển Passat từng đoạt danh hiệu ''European Car of the Year'' vượt qua các tiêu chuẩn về an toàn và khí thải khắc khe của Châu Âu.</p>
            <p>- Volkswagen Passat với phiên bản BlueMotion là phiên bản cao cấp nhất có mặt tại Việt Nam. Đúng với tên Bluemotion, Passat là một chiếc xe thân thiện với môi trường và tiết kiệm nhiên liệu.</p>
          </div>
        </div>
        ...
        <div id="thiet-ke" class="block-product">
          ...
          <div class="content-block">
            <h4>Ngoại thất</h4>
            <ul>
              <li>Kiểu dáng lịch lãm và cân xứng mang đậm phong cách thiết kế người Đức</li>
              <li>Lưới tản nhiệt 4 nan ngang nối hai đèn pha cùng logo lớn nằm ở chính giữa</li>
              <li>Huy hiêu “Bluemotion” gắn phía sau xe</li>
              <li>Hai đường khí động học dập nổi tren nóc ca pô</li>
              <li>Cụm đèn pha Led được thiết kế tinh tế và ẩn bên trong là dải Led xi nhan</li>
              <li>Gương hậu gập điện, chỉnh điện, và tích hợp báo rẽ</li>
              <li>Mâm hợp kim Dartford 18-inch đặc trưng cứng cáp và tinh tế</li>
              <li>Ống sả kép bên trái</li>
            ...
            <ul>
              ...
              <li>Cụm đồng hồ trung tâm mạ crom kèm màn hình kỹ thuật số thể hiện đa thông tin</li>
        ...
        <div id="an-toan" class="block-product">
          ...
          <div class="content-block">
            ...
            <ul>
              ...
              <li>Cân bằng điện tử (ESP)</li>
              <li>Hệ thống hỗ trợ kiểm soát độ bám đường (ETC)</li>
              <li>Kiểm soát hành trình</li>
              <li>Hỗ trợ phanh (BA)</li>
